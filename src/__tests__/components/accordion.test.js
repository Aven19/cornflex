...
describe('<Accordion />', () => {
  it('renders the <Accordion /> with populated data', () => {
    ...
    expect(getByText('What is Cornflex?')).toBeTruthy();
    expect(getByText('How much does Cornflex cost?')).toBeTruthy();
    expect(getByText('Where can I watch?')).toBeTruthy();
    expect(getByText('How do I cancel?')).toBeTruthy();
    expect(getByText('What can I watch on Cornflex?')).toBeTruthy();
